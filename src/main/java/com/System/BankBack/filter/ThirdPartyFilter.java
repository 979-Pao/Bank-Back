...
public class ThirdPartyFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req,
                                    ...
                                    FilterChain fc) throws ServletException, java.io.IOException {
        ...
        String key = req.getHeader("X-Hashed-Key");

        if (key == null || tpRepo.findByHashKey(key) == null) {
            res.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Invalid third-party key");
            return;
        }
